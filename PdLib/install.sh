...
xcodebuild -sdk iphoneos3.2 -target pd "ARCHS=armv6 armv7" "VALID_ARCHS=armv6 armv7" build
xcodebuild -sdk iphonesimulator3.2 -target pd "ARCHS=i386 x86_64" "VALID_ARCHS=i386 x86_64" build
